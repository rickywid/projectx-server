...
import getUserProjectsRouter from './routes/getUserProjects';
import getUserLikedProjectsRouter from './routes/getUserLikedProjects';
import getUserSavedProjectsRouter from './routes/getUserSavedProjects';
...
app.use('/api/user', getUserProjectsRouter);
app.use('/api/user', getUserLikedProjectsRouter);
app.use('/api/user', getUserSavedProjectsRouter);
